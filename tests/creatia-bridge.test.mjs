...
assert.doesNotMatch(coCreateInstructions, /quoteField/)
assert.match(coCreateInstructions, /generic projector/)
assert.match(coCreateInstructions, /statePatch keys such as title/)
assert.match(coCreateInstructions, /Never render JSON\.stringify\(runtimePayload\)/)
assert.match(coCreateInstructions, /JSON\.stringify\(statePatch\)/)
...
assert.doesNotMatch(runtimeInstructions, /quoteField/)
assert.match(runtimeInstructions, /type: \"card\"/)
...
assert.match(pipeline, /statePatch/)
assert.match(pipeline, /textarea/)
